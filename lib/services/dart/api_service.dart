...
class ApiService {
  static const String baseUrl =
      'https://web-production-4b65.up.railway.app';
  ...
  Future<dynamic> _get(String path) async {
    try {
      ...
      throw ApiException(408, "Request timeout");
    } on SocketException {
  ...
  Future<void> _delete(String path) async {
    try {
      ...
      throw ApiException(408, "Delete request timeout");
    } on SocketException {
  ...
  dynamic _handle(http.Response r) {
    ...
    print(
        "API DEBUG ${r.request?.method} ${r.request?.url} → ${r.statusCode}");
    ...
    try {
      ...
      throw ApiException(r.statusCode, "Invalid JSON response");
    }
  }
  ...
  Future<Map<String, dynamic>> analyzeImage(File imageFile) async {
    ...
    try {
      ...
      throw ApiException(408, "Image upload timeout");
    }
  }
  ...
  Future<Map<String, dynamic>> logWithImage({
    ...
    try {
      ...
      throw ApiException(408, "Food logging timeout");
    }
  }
...
final apiService = ApiService();      'POST',
      Uri.parse('$baseUrl/food/log/image'),
    );
    request.headers['Authorization'] = 'Bearer $_token';
    request.fields['meal_type'] = mealType;
